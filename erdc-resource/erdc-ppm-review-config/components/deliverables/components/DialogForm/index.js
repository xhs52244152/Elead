define([
    'text!' + ELMP.resource('erdc-ppm-review-config/components/deliverables/components/DialogForm/index.html'),
    'erdcloud.kit',
    'css!' + ELMP.resource('erdc-ppm-review-config/components/deliverables/components/DialogForm/style.css')
        ...
        data() {
            return {
                ...
                i18nLocalePath: ELMP.resource(
                    'erdc-ppm-review-config/components/deliverables/components/DialogForm/locale/index.js'
                ),
                i18nMappingObj: {
