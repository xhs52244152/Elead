define([
    ELMP.func('erdc-part/actions.js'),
    ELMP.func('erdc-part/config/common-page-config.js'),
    ELMP.resource('erdc-cbb-workflow/index.js'),
    ELMP.resource('erdc-part/store.js')
], function (actions, getConfig, registerWorkflow, partStore) {
    const ErdcStore = require('erdcloud.store');

    function init() {
        // 初始化actions
        let customActions = ErdcStore.getters?.['pdmPartStore/getCustomActions'] || {};
    ...
    function useActions(customActions) {
        ErdcStore.registerModule('pdmPartStore', partStore);
