define([
    'text!' + ELMP.resource('project-dashboard/components/RequirementReport/components/DemandSources/index.html'),
    ...
    return {
        ...
        methods: {
            drawLine() {
                ...
                if (document.getElementById('demandSources')) {
                    const myChart = echarts.init(document.getElementById('demandSources'));
                    // 绘制图表
                    myChart.setOption({
                        title: [
                            {
