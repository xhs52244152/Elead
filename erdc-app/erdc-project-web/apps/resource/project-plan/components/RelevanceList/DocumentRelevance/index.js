define([
    'erdcloud.kit',
    'text!' + ELMP.resource('project-plan/components/RelevanceList/DocumentRelevance/index.html'),
    ...
    const listComponent = {
        ...
        data() {
            return {
                ...
                i18nMappingObj: {
                    ...
                    whetherDeleteDelivery: this.getI18nByKey('whetherDeleteDelivery'),
        ...
        methods: {
            ...
            deleteData(params, type = '') {
                this.$confirm(this.i18nMappingObj.whetherDeleteDelivery, this.i18nMappingObj.checkDelete, {
