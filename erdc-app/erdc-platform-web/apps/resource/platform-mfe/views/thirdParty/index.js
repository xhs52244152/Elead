define([
    'text!' + ELMP.resource('platform-mfe/views/thirdParty/index.html'),
    'erdc-kit',
    ELMP.resource('platform-mfe/api.js'),
    'css!' + ELMP.resource('platform-mfe/index.css')
], function (template, FamUtils, api) {
    ...
    return {
        ...
        methods: {
            ...
            refreshTable() {
                this.$refs.thirdTable?.fnRefreshTable();
            },
            download(row) {
                FamUtils.downFile({
                    url: `/platform/mfe/apps/download/erdc-thirdparty/${row.id}`,
                    notify: true
                });
            },
            saveVersion(id) {
