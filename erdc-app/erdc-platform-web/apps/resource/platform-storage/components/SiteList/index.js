define([
    ...
    'text!' + ELMP.resource('platform-doc/site/components/siteList/index.html'),
    'css!' + ELMP.resource('platform-doc/site/components/siteList/index.css')
        ...
        methods: {
            ...
            getSpeedPromise(site) {
                return new Promise((resolve, reject) => {
                    ...
                    const headers = window.ELCONF.getDefaultAjaxHeaders();
