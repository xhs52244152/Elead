    ...
    return [
        {
            path: '/',
            name: 'plat',
            component: ErdcKit.asyncComponent('/erdc-layout/ultra-horizontal/Layout.js'),
            meta: {
            ...
            children: [
                {
                    ...
                    component: ErdcKit.asyncComponent('/erdc-layout/ultra-horizontal/RootLayout.js')
                },
                {
                    path: '/space',
                    name: 'space',
                    component: ErdcKit.asyncComponent('/erdc-layout/ultra-horizontal/SpaceLayout/index.js'),
                    meta: {
                        keepAlive: true,
