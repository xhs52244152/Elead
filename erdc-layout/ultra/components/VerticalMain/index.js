define(['erdcloud.kit', 'css!/erdc-layout/ultra/style/index.css'], function () {
            ...
            >
                ...
                >
                    <FamSideMenu
                        ...
                        :hideResourceChildren="hideResourceChildren"
                        @routeTo="routeTo"
                    ></FamSideMenu>
                </div>
                <div :class="{
                    ...
                    <div 
                        class="fam-main__right-content flex flex-column" 
