...
define([
    ...
    'css!/erdc-layout/ultra/style/reset.css'
], function () {
 ...
 * @description 通用工具
 */
define('layout:ultra:component:util', ['text!/erdc-layout/ultra/template.html'], function (template) {
    ...
    return {
        ...
        methods: {
            ...
            getRouteTitle(route) {
                ...
                return route.displayName || route.name || route.path;
            },
