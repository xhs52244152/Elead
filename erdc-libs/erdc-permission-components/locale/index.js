...
define([], function () {
    ...
    const languageObj = {
        ...
        tooltips: {
            CN: '如需要查看在当前上下文下的某个类型的最终访问权限时，请选择类型、状态后进行查看',
            EN: 'If you want to view the final access permission of a certain type in the current context, select the type and status and view the permission'
        },
        inheritParent: {
            CN: '展示继承父级',
            EN: 'Show the inheritance parent'
        }
    };
