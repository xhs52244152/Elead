define([
    'text!' + ELMP.resource('erdc-pdm-common-actions/components/DialogHandler/index.html'),
    ELMP.func('erdc-document/api.js'),
    'css!' + ELMP.resource('erdc-pdm-common-actions/components/DialogHandler/style.css')
    ...
    return {
        ...
        components: {
            ...
            DialogBatch: ErdcKit.asyncComponent(
                ELMP.resource('erdc-pdm-common-actions/components/DialogBatch/index.js')
            ),
        ...
        methods: {
            ...
            init() {
                ...
                this.tableData = rowList.map((item) => {
                    ...
                    rowData['ownedByRef'] = ownedByRefObj?.displayName || rowData['ownedByRef'] || '';
                    rowData[`${this.className}#ownedByRef`] =
                        ownedByRefObj?.displayName || rowData[`${this.className}#ownedByRef`] || '';
